...
- [DPRK Reports Database Company Search](https://dprk-reports.org/search?filter%3Aschema=Company)
...
## Vehicles
### Land
- [Transport in North Korea | Wiki](https://en.wikipedia.org/wiki/Transport_in_North_Korea)
- [North Korea Railways (OpenStreetMap Export)](https://data.humdata.org/dataset/hotosm_prk_railways)
...
### Avia
- [North Korea on Flight Radar](https://www.flightradar24.com/data/airports/north-korea)
...
- Due to the low internet covering there could be leak of information. But you can still try [OSINT Industries](https://app.osint.industries) or find smth usable on Pogoda's [Digital Profiler's Toolkit](https://github.com/paulpogoda/Digital-Profiler-s-Toolkit)
...
## Appendix
- [NK PRO Paid Research Tool](https://signup.nknews.org/nk-pro/) could be very useful 
- [38 North](https://www.38north.org). 38 North, a publication of the Stimson Center, is a source of policy and technical analysis regarding North Korea’s internal and external affairs
